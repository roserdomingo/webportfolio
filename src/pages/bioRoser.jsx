        ...
        <div className='row'>
          <div className='col-sm-12'>
            <ul className='list-group mb-4'>
              ...
              <li className='list-group-item px-4'>
                En el ámbito de los nuevos medios, ha sido artista residente en varias convocatorias y su trabajo ha sido reconocido con diversos premios. Su obra, tanto en formato instalativo como performático, ha sido expuesta y realizada en festivales, congresos y en salas de renombre de España, como Matadero Madrid, Centre del Carme Cultura Contemporània, Centre de Cultura Contemporània de Barcelona, Sala Josep Renau, Auditorio Alfons Roig, Bombas Gens, Centro de Arte y Tecnología Etopia, Las Cigarreras, La Mutant, Teatre El Musical, El Rialto, Feria Valencia, Las Naves, Veles e Vents y Espai Jove VLC, entre otras, y en ciudades fuera del país como São Paulo, Roma, Münster, Berlín, Calgary, West Lafayette, Praga, Valparaíso, Bogotá, Manizales o La Habana.
              </li>
              <li className='list-group-item px-4'>
        ...
        <div className='row text-secondary'>
          <div className='col-sm-12'>
            <ul className='list-group mb-4'>
              ...
              <li className='list-group-item px-4 text-secondary'>
                Over the years she has grown and developed in both the sound and visual fields, combining these disciplines in her artistic practice. Her interest in teaching has also led her to participate in educational projects aimed at bringing different aspects of art to young people and the general public. She has also collaborated as a teacher of subjects at the Faculty of Fine Arts (due to her pre-doctoral contract with the UPV) and worked for a short time as a teacher of music technology at the «Salvador Seguí» Superior Conservatory of Music in Castelló. She has shared her knowledge and experience through various presentations, conferences, courses and workshops that she has given during this period.
              </li>
              <li className='list-group-item px-4 text-secondary'>
